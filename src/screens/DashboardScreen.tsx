...
const HeaderBackground = () => (
  <Svg width={SIZES.screenWidth} height={SIZES.headerHeight} viewBox="0 0 430 221" style={{ position: 'absolute', top: 0, left: 0 }}>
    <Defs>
      <LinearGradient id="paint0_linear_1_860" x1="266.5" y1="14" x2="93" y2="220.5" gradientUnits="userSpaceOnUse">
...
const NestedCircles = () => (
  <Svg width={SIZES.nestedCirclesWidth} height={SIZES.nestedCirclesHeight} viewBox="0 0 215 164" style={{ position: 'absolute', top: 0, left: 0 }}>
    <Defs>
      <LinearGradient id="paint0_linear_1_861" x1="-0.54727" y1="-14.6342" x2="-26.7667" y2="164.574" gradientUnits="userSpaceOnUse">
        <Stop stopColor={COLORS.secondary}/>
        <Stop offset="1" stopColor={COLORS.secondaryLight}/>
      </LinearGradient>
      <LinearGradient id="paint1_linear_1_861" x1="-0.54727" y1="-14.6342" x2="-26.7667" y2="164.574" gradientUnits="userSpaceOnUse">
        <Stop stopColor={COLORS.secondary}/>
        <Stop offset="1" stopColor={COLORS.secondaryLight}/>
      </LinearGradient>
    </Defs>
  ...
  return (
    <View style={{ width: size, height: size }}>
      ...
      <View style={{
        ...
        <Text style={{ fontSize: 12, fontWeight: '600', color: '#333' }}>{timeText}</Text>
      </View>
    </View>
  );
};
...
const FeatureCard = ({ title, emoji, icon, testID }: { title: string; emoji?: string; icon?: React.ReactNode; testID?: string }) => (
  <View testID={testID} style={featureStyles.cardShadowA}>
    <View style={featureStyles.cardShadowB}>
      <View style={featureStyles.card}>
        {icon ? <View>{icon}</View> : <Text style={featureStyles.icon}>{emoji}</Text>}
...
const SalaryIcon = () => (
  <Svg width={24} height={25} viewBox="0 0 24 25" fill="none">
    <Defs>
      <LinearGradient id="salary_p0" x1={17} y1={2.5} x2={7.37037} y2={22.5} gradientUnits="userSpaceOnUse">
        <Stop stopColor="#00E1E1" />
        <Stop offset={1} stopColor="#24BABB" />
      </LinearGradient>
      <LinearGradient id="salary_p1" x1={12.75} y1={17.5} x2={12.2685} y2={18.5} gradientUnits="userSpaceOnUse">
        <Stop stopColor="#00E1E1" />
        <Stop offset={1} stopColor="#24BABB" />
      </LinearGradient>
      <LinearGradient id="salary_p2" x1={12.75} y1={6.5} x2={12.2685} y2={7.5} gradientUnits="userSpaceOnUse">
        <Stop stopColor="#00E1E1" />
        <Stop offset={1} stopColor="#24BABB" />
      </LinearGradient>
      <LinearGradient id="salary_p3" x1={13.5} y1={7.5} x2={7.48706} y2={14.993} gradientUnits="userSpaceOnUse">
        <Stop stopColor="#00E1E1" />
        <Stop offset={1} stopColor="#24BABB" />
      </LinearGradient>
    </Defs>
    <Circle cx={12} cy={12.5} r={10} stroke="url(#salary_p0)" strokeWidth={1.5} />
    <Path d="M12 17.5V18V18.5" stroke="url(#salary_p1)" strokeWidth={1.5} strokeLinecap="round" />
    <Path d="M12 6.5V7V7.5" stroke="url(#salary_p2)" strokeWidth={1.5} strokeLinecap="round" />
    <Path d="M15 10C15 8.61929 13.6569 7.5 12 7.5C10.3431 7.5 9 8.61929 9 10C9 11.3807 10.3431 12.5 12 12.5C13.6569 12.5 15 13.6193 15 15C15 16.3807 13.6569 17.5 12 17.5C10.3431 17.5 9 16.3807 9 15" stroke="url(#salary_p3)" strokeWidth={1.5} strokeLinecap="round" />
  </Svg>
);

const KPIIcon = () => (
<Svg width="24" height="25" viewBox="0 0 24 25" fill="none">
    <Path d="M13.75 10.5C13.75 10.9142 14.0858 11.25 14.5 11.25H15.1893L13.1768 13.2626C13.0791 13.3602 12.9209 13.3602 12.8232 13.2626L11.2374 11.6768C10.554 10.9934 9.44598 10.9934 8.76256 11.6768L6.46967 13.9697C6.17678 14.2626 6.17678 14.7374 6.46967 15.0303C6.76256 15.3232 7.23744 15.3232 7.53033 15.0303L9.82322 12.7374C9.92085 12.6398 10.0791 12.6398 10.1768 12.7374L11.7626 14.3232C12.446 15.0066 13.554 15.0066 14.2374 14.3232L16.25 12.3107V13C16.25 13.4142 16.5858 13.75 17 13.75C17.4142 13.75 17.75 13.4142 17.75 13V10.5C17.75 10.0858 17.4142 9.75 17 9.75H14.5C14.0858 9.75 13.75 10.0858 13.75 10.5Z" fill="url(#paint0_linear_2_57)"/>
    <Path fill-rule="evenodd" clip-rule="evenodd" d="M11.9426 1.75C9.63423 1.74999 7.82519 1.74998 6.41371 1.93975C4.96897 2.13399 3.82895 2.53933 2.93414 3.43414C2.03933 4.32895 1.63399 5.46897 1.43975 6.91371C1.24998 8.32519 1.24999 10.1342 1.25 12.4426V12.5574C1.24999 14.8658 1.24998 16.6748 1.43975 18.0863C1.63399 19.531 2.03933 20.6711 2.93414 21.5659C3.82895 22.4607 4.96897 22.866 6.41371 23.0603C7.82519 23.25 9.63423 23.25 11.9426 23.25H12.0574C14.3658 23.25 16.1748 23.25 17.5863 23.0603C19.031 22.866 20.1711 22.4607 21.0659 21.5659C21.9607 20.6711 22.366 19.531 22.5603 18.0863C22.75 16.6748 22.75 14.8658 22.75 12.5574V12.4426C22.75 10.1342 22.75 8.32519 22.5603 6.91371C22.366 5.46897 21.9607 4.32895 21.0659 3.43414C20.1711 2.53933 19.031 2.13399 17.5863 1.93975C16.1748 1.74998 14.3658 1.74999 12.0574 1.75H11.9426ZM3.9948 4.4948C4.56445 3.92514 5.33517 3.59825 6.61358 3.42637C7.91356 3.25159 9.62178 3.25 12 3.25C14.3782 3.25 16.0864 3.25159 17.3864 3.42637C18.6648 3.59825 19.4355 3.92514 20.0052 4.4948C20.5749 5.06445 20.9018 5.83517 21.0736 7.11358C21.2484 8.41356 21.25 10.1218 21.25 12.5C21.25 14.8782 21.2484 16.5864 21.0736 17.8864C20.9018 19.1648 20.5749 19.9355 20.0052 20.5052C19.4355 21.0749 18.6648 21.4018 17.3864 21.5736C16.0864 21.7484 14.3782 21.75 12 21.75C9.62178 21.75 7.91356 21.7484 6.61358 21.5736C5.33517 21.4018 4.56445 21.0749 3.9948 20.5052C3.42514 19.9355 3.09825 19.1648 2.92637 17.8864C2.75159 16.5864 2.75 14.8782 2.75 12.5C2.75 10.1218 2.75159 8.41356 2.92637 7.11358C3.09825 5.83517 3.42514 5.06445 3.9948 4.4948Z" fill="url(#paint1_linear_2_57)"/>
    <Path d="M13.75 10.5C13.75 10.9142 14.0858 11.25 14.5 11.25H15.1893L13.1768 13.2626C13.0791 13.3602 12.9209 13.3602 12.8232 13.2626L11.2374 11.6768C10.554 10.9934 9.44598 10.9934 8.76256 11.6768L6.46967 13.9697C6.17678 14.2626 6.17678 14.7374 6.46967 15.0303C6.76256 15.3232 7.23744 15.3232 7.53033 15.0303L9.82322 12.7374C9.92085 12.6398 10.0791 12.6398 10.1768 12.7374L11.7626 14.3232C12.446 15.0066 13.554 15.0066 14.2374 14.3232L16.25 12.3107V13C16.25 13.4142 16.5858 13.75 17 13.75C17.4142 13.75 17.75 13.4142 17.75 13V10.5C17.75 10.0858 17.4142 9.75 17 9.75H14.5C14.0858 9.75 13.75 10.0858 13.75 10.5Z" stroke="url(#paint2_linear_2_57)"/>
    <Path fill-rule="evenodd" clip-rule="evenodd" d="M11.9426 1.75C9.63423 1.74999 7.82519 1.74998 6.41371 1.93975C4.96897 2.13399 3.82895 2.53933 2.93414 3.43414C2.03933 4.32895 1.63399 5.46897 1.43975 6.91371C1.24998 8.32519 1.24999 10.1342 1.25 12.4426V12.5574C1.24999 14.8658 1.24998 16.6748 1.43975 18.0863C1.63399 19.531 2.03933 20.6711 2.93414 21.5659C3.82895 22.4607 4.96897 22.866 6.41371 23.0603C7.82519 23.25 9.63423 23.25 11.9426 23.25H12.0574C14.3658 23.25 16.1748 23.25 17.5863 23.0603C19.031 22.866 20.1711 22.4607 21.0659 21.5659C21.9607 20.6711 22.366 19.531 22.5603 18.0863C22.75 16.6748 22.75 14.8658 22.75 12.5574V12.4426C22.75 10.1342 22.75 8.32519 22.5603 6.91371C22.366 5.46897 21.9607 4.32895 21.0659 3.43414C20.1711 2.53933 19.031 2.13399 17.5863 1.93975C16.1748 1.74998 14.3658 1.74999 12.0574 1.75H11.9426ZM3.9948 4.4948C4.56445 3.92514 5.33517 3.59825 6.61358 3.42637C7.91356 3.25159 9.62178 3.25 12 3.25C14.3782 3.25 16.0864 3.25159 17.3864 3.42637C18.6648 3.59825 19.4355 3.92514 20.0052 4.4948C20.5749 5.06445 20.9018 5.83517 21.0736 7.11358C21.2484 8.41356 21.25 10.1218 21.25 12.5C21.25 14.8782 21.2484 16.5864 21.0736 17.8864C20.9018 19.1648 20.5749 19.9355 20.0052 20.5052C19.4355 21.0749 18.6648 21.4018 17.3864 21.5736C16.0864 21.7484 14.3782 21.75 12 21.75C9.62178 21.75 7.91356 21.7484 6.61358 21.5736C5.33517 21.4018 4.56445 21.0749 3.9948 20.5052C3.42514 19.9355 3.09825 19.1648 2.92637 17.8864C2.75159 16.5864 2.75 14.8782 2.75 12.5C2.75 10.1218 2.75159 8.41356 2.92637 7.11358C3.09825 5.83517 3.42514 5.06445 3.9948 4.4948Z" stroke="url(#paint3_linear_2_57)"/>
    <Defs>
    <LinearGradient id="paint0_linear_2_57" x1="17.375" y1="1.75" x2="7.02315" y2="23.25" gradientUnits="userSpaceOnUse">
        <Stop stopColor="#00E1E1"/>
        <Stop offset="1" stopColor="#24BABB"/>
    </LinearGradient>
    <LinearGradient id="paint1_linear_2_57" x1="17.375" y1="1.75" x2="7.02315" y2="23.25" gradientUnits="userSpaceOnUse">
        <Stop stopColor="#00E1E1"/>
        <Stop offset="1" stopColor="#24BABB"/>
    </LinearGradient>
    <LinearGradient id="paint2_linear_2_57" x1="17.375" y1="1.75" x2="7.02315" y2="23.25" gradientUnits="userSpaceOnUse">
        <Stop stopColor="#00E1E1"/>
        <Stop offset="1" stopColor="#24BABB"/>
    </LinearGradient>
    <LinearGradient id="paint3_linear_2_57" x1="17.375" y1="1.75" x2="7.02315" y2="23.25" gradientUnits="userSpaceOnUse">
        <Stop stopColor="#00E1E1"/>
        <Stop offset="1" stopColor="#24BABB"/>
    </LinearGradient>
    </Defs>
...
const CheckboxIcon = ({ checked = false, size = 20 }: { checked?: boolean; size?: number }) => (
  <Svg width={size} height={size} viewBox="0 0 20 20" fill="none">
    {checked ? (
      // Checked state
      <>
        <Rect x="2" y="2" width="16" height="16" rx="4" fill="#3B76DA" stroke="#3B76DA" strokeWidth="1"/>
        <Path d="M7 10L9 12L13 8" stroke="white" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
      </>
    ) : (
      // Unchecked state
      <Rect x="2" y="2" width="16" height="16" rx="4" stroke="#D0D5DD" strokeWidth="1" fill="white"/>
    )}
  </Svg>
);
				...
				<View style={{ 
					...
					<View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
						<View style={{ 
							...
							<Text style={{ fontSize: 20, color: COLORS.primaryDark }}>HM</Text>
						</View>
						...
						<View style={{ flex: 1 }}>
							...
							<Text style={{ ...titleTextStyle, opacity: 0.9, fontFamily: FONTS.lexend }}>
								Hôm nay bạn đã làm <Text style={boldTextStyle}>20</Text> ca rồi - tuyệt vời!
							</Text>
						</View>
					</View>
					...
					<View style={styles.frameContainerShadowA}>
						<View style={styles.frameContainerShadowB}>
								...
								<View style={styles.frameItem}>
									<View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6}}>
										...
										<View style={{ flexDirection: 'row', alignItems: 'center' }}>
											...
											{/* More Options Icon */}
											<Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
												<Path d="M9 12C9 12.5523 8.55228 13 8 13C7.44772 13 7 12.5523 7 12C7 11.4477 7.44772 11 8 11C8.55228 11 9 11.4477 9 12Z" fill="#667085"/>
												<Path d="M13 12C13 12.5523 12.5523 13 12 13C11.4477 13 11 12.5523 11 12C11 11.4477 11.4477 11 12 11C12.5523 11 13 11.4477 13 12Z" fill="#667085"/>
												<Path d="M17 12C17 12.5523 16.5523 13 16 13C15.4477 13 15 12.5523 15 12C15 11.4477 15.4477 11 16 11C16.5523 11 17 11.4477 17 12Z" fill="#667085"/>
												<Path 
													fillRule="evenodd" 
													clipRule="evenodd" 
									...
									<View style={{ flexDirection: 'row', alignItems: 'center' }}>
										<Svg width="20" height="20" viewBox="0 0 20 20" fill="none" style={{ marginRight: 6 }}>
											<Path d="M11.9841 6.68934C12.4806 6.51593 13.0149 6.42157 13.5714 6.42157C14.117 6.42157 14.6411 6.51223 15.1292 6.67915M5.93013 8.84072C5.70625 8.79728 5.47486 8.77451 5.2381 8.77451C3.26565 8.77451 1.66667 10.3547 1.66667 12.3039C1.66667 13.8843 2.7177 15.222 4.16667 15.6718M5.93013 8.84072C5.73922 8.3315 5.63492 7.78073 5.63492 7.20588C5.63492 4.6069 7.7669 2.5 10.3968 2.5C12.8466 2.5 14.8643 4.32809 15.1292 6.67915M5.93013 8.84072C6.40049 8.93199 6.83774 9.1145 7.22222 9.36884M15.1292 6.67915C16.9941 7.31686 18.3333 9.0676 18.3333 11.1275C18.3333 13.0798 17.1302 14.7545 15.4167 15.467" stroke="#3B76DA" stroke-width="1.25" stroke-linecap="round"/>
											<Path d="M9.16667 16.9444C9.16667 17.7115 8.60702 18.3333 7.91667 18.3333C7.22631 18.3333 6.66667 17.7115 6.66667 16.9444C6.66667 16.5237 7.04269 15.9796 7.38226 15.574C7.66527 15.2359 8.16806 15.2359 8.45108 15.574C8.79065 15.9796 9.16667 16.5237 9.16667 16.9444Z" stroke="#3B76DA" stroke-width="1.25"/>
											<Path d="M13.3333 16.9444C13.3333 17.7115 12.7737 18.3333 12.0833 18.3333C11.393 18.3333 10.8333 17.7115 10.8333 16.9444C10.8333 16.5237 11.2094 15.9796 11.5489 15.574C11.8319 15.2359 12.3347 15.2359 12.6177 15.574C12.9573 15.9796 13.3333 16.5237 13.3333 16.9444Z" stroke="#3B76DA" stroke-width="1.25"/>
											<Path d="M11.25 12.7778C11.25 13.5448 10.6904 14.1667 10 14.1667C9.30964 14.1667 8.75 13.5448 8.75 12.7778C8.75 12.3571 9.12602 11.8129 9.46559 11.4073C9.7486 11.0692 10.2514 11.0692 10.5344 11.4073C10.874 11.8129 11.25 12.3571 11.25 12.7778Z" stroke="#3B76DA" stroke-width="1.25"/>
										</Svg>
										<Text style={styles.frameTitle}>Hôm nay trời mưa - nên đi sớm 10 phút</Text>
									</View>
								</View>
								
								{/* Countdown row: timer and message on the same line, centered */}
								<View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingLeft:10, paddingRight:10, borderLeftWidth:2, borderLeftColor: '#3B76DA', height: 68, borderRadius: 4, backgroundColor: '#F5F8FD' }}>
									<CountdownTimer size={48} strokeWidth={3} progress={0.33} timeText="40:00" />
									<View style={{ flex: 1 }}>
										<Text style={[styles.frameTitleSmall, { marginLeft: 8, marginBottom: 0 }]}>Còn <Text style={{ fontWeight: '700' }}>40</Text> phút nữa tới giờ làm. Hãy chuẩn bị ngay</Text>
									</View>
								</View>

								<View style={{ height: 1, width: '100%', backgroundColor: '#E0E0E0', alignSelf: 'stretch', marginTop: 16, marginBottom: 16 }} />

								{/* Ca sắp tới kèm thời gian */}
								<View style={{marginBottom: 0}}>
									<View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
										<Text style={[styles.frameTitleBold, styles.marginRight12]}>08:00 - 16:00</Text>
										<View style={{ flexDirection: 'row', alignItems: 'center' }}>
											<Text style={[styles.frameTitle, styles.marginRight12]}>Ca sắp tới</Text>
											<Svg width="20" height="20" viewBox="0 0 20 20" fill="none">
												<Path d="M8.5 6L13.5 10L8.5 14" stroke="#667085" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
											</Svg>
										</View>
									</View>
								</View>
							...
							<View>
								...
								<View style={{ marginBottom: 16 }}>
									<View style={featureStyles.row}>
										<FeatureCard testID="FeatureCard-Salary" title="Lương" icon={<SalaryIcon />} />
										<FeatureCard testID="FeatureCard-KPI" title="KPI" icon={<KPIIcon />} />
										<FeatureCard testID="FeatureCard-Shortcut" title="Đặt lịch" icon={<WindowIcon />} />
									</View>
								</View>
								...
								<View style={{ marginBottom: 0 }}>
									<View style={featureStyles.row}>
										<FeatureCard testID="FeatureCard-Report" title="Báo cáo" icon={<ChartIcon />} />
										<FeatureCard testID="FeatureCard-Rocket" title="Trung tâm cải tiến" icon={<RocketIcon />} />
										<FeatureCard testID="FeatureCard-Cart" title="Nhập hàng" icon={<ShopIcon />} />
							    </View>
						    </View>
                            ...
                            <View style={[styles.frameContainerShadowA, { marginTop: 16 }]}>
                                <View style={styles.frameContainerShadowB}>
                                    <View style={[styles.frameContainer, { gap: 12, padding: 0, paddingTop: 16, paddingBottom: 16, }]}>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingLeft: 16, paddingRight: 16 }}>
                                            <Text style={[styles.frameTitleBold]}>Bạn cảm thấy hôm nay thế nào</Text>
                                        </View>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingLeft: 16, paddingRight: 16 }}>
                                            <Image style={{ width: 44, height: 44 }} source={require('../../assets/emotion-face/pouting-face.gif')} />
                                            <Image style={{ width: 44, height: 44 }} source={require('../../assets/emotion-face/pensive-face.gif')} />
                                            <Image style={{ width: 44, height: 44 }} source={require('../../assets/emotion-face/neutral-face.gif')} />
                                            <Image style={{ width: 44, height: 44 }} source={require('../../assets/emotion-face/slightly-smiling-face.gif')} />
                                            <Image style={{ width: 44, height: 44 }} source={require('../../assets/emotion-face/grinning-face.gif')} />
                                        </View>
                                    </View>
                                </View>
                            </View>

                            <View style={{ backgroundColor: '#FFF3D1', borderRadius: 12, gap: 12}}>
                                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 16, paddingBottom: 0}}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                                        <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            <Path d="M8.37671 15.6164L2.71986 21.2732M11.6944 6.64188L10.1335 8.20276C10.0062 8.33009 9.94252 8.39375 9.86999 8.44433C9.80561 8.48923 9.73617 8.5264 9.6631 8.55506C9.58078 8.58735 9.49249 8.60501 9.31593 8.64032L5.65146 9.37321C4.69916 9.56367 4.22301 9.6589 4.00025 9.90996C3.80618 10.1287 3.71756 10.4214 3.75771 10.711C3.8038 11.0434 4.14716 11.3868 4.83388 12.0735L11.9196 19.1593C12.6063 19.846 12.9497 20.1893 13.2821 20.2354C13.5718 20.2756 13.8645 20.1869 14.0832 19.9929C14.3342 19.7701 14.4295 19.294 14.6199 18.3417L15.3528 14.6772C15.3881 14.5006 15.4058 14.4124 15.4381 14.33C15.4667 14.257 15.5039 14.1875 15.5488 14.1231C15.5994 14.0506 15.663 13.9869 15.7904 13.8596L17.3513 12.2987C17.4327 12.2173 17.4734 12.1766 17.5181 12.1411C17.5578 12.1095 17.5999 12.081 17.644 12.0558C17.6936 12.0275 17.7465 12.0048 17.8524 11.9595L20.3467 10.8905C21.0744 10.5786 21.4383 10.4227 21.6035 10.1707C21.7481 9.95031 21.7998 9.68181 21.7474 9.42354C21.6875 9.12819 21.4076 8.84828 20.8478 8.28846L15.7047 3.14532C15.1448 2.58549 14.8649 2.30558 14.5696 2.24571C14.3113 2.19335 14.0428 2.24506 13.8225 2.38959C13.5705 2.55487 13.4145 2.91872 13.1027 3.64642L12.0337 6.14078C11.9883 6.24659 11.9656 6.2995 11.9373 6.34911C11.9121 6.39319 11.8836 6.43528 11.852 6.47503C11.8165 6.51977 11.7758 6.56047 11.6944 6.64188Z" stroke="#F04438" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        </Svg>
                                        <Text style={styles.frameTitleBold}>Nhiệm vụ hôm nay</Text>
                                    </View>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                                        <Svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                                            <Path d="M7.33332 12.6667V8.66669H3.33332C2.96513 8.66669 2.66666 8.36821 2.66666 8.00002C2.66666 7.63183 2.96513 7.33335 3.33332 7.33335H7.33332V3.33335C7.33332 2.96516 7.6318 2.66669 7.99999 2.66669C8.36818 2.66669 8.66666 2.96516 8.66666 3.33335V7.33335H12.6667C13.0348 7.33335 13.3333 7.63183 13.3333 8.00002C13.3333 8.36821 13.0348 8.66669 12.6667 8.66669H8.66666V12.6667C8.66666 13.0349 8.36818 13.3334 7.99999 13.3334C7.6318 13.3334 7.33332 13.0349 7.33332 12.6667Z" fill="#3B76DA"/>
                                        </Svg>
                                        <Text style={styles.titleHref}>Thêm nhiệm vụ</Text>
                                    </View>
                                </View>
                                <View style={{padding: 16, gap: 12, paddingTop: 0, paddingBottom: 0}}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', borderRadius: 4 }}>
                                        <CheckboxIcon checked={false} size={20} />
                                        <Text style={styles.titleCheckBox}>Kiểm kê kho cuối ngày</Text>
                                    </View>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', borderRadius: 4 }}>
                                        <CheckboxIcon checked={false} size={20} />
                                        <Text style={styles.titleCheckBox}>Bàn giao công việc cho ca sau</Text>
                                    </View>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', borderRadius: 4 }}>
                                        <CheckboxIcon checked={false} size={20} />
                                        <Text style={styles.titleCheckBox}>Ghi nhận KPI khách hàng phản hồi</Text>
                                    </View>
                                </View>
